...
#COPY .docker/users/env.sample.php /var/www/html/app/etc/env.php
...
COPY auth.json /var/www/html/.composer/auth.json
RUN chmod 777 /var/www/html/.composer

#CMD rm -rf /var/www/html/* && /usr/local/bin/install-magento2 && apache2-foreground

#CMD ["/usr/local/bin/install-magento2", "-c", "2.2"]
